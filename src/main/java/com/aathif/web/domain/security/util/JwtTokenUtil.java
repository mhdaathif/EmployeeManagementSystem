package com.aathif.web.domain.security.util;
...
public class JwtTokenUtil {
    ...
    public String generateAccessToken(User user) {
        ...
        return generateToken(claims, accessTokenLife, user.getUsername());
    }
    ...
    public String generateRefreshToken(User user) {
        ...
        return generateToken(claims, refreshTokenLife, user.getUsername());
    }
}
